...
INSERT INTO `Despesa` VALUES ('0000-00-00',0,NULL,NULL),('2024-05-10',3,1,35),('2024-05-15',1,500,1500),('2024-05-16',8,330,470),('2024-06-15',1,550,1650),('2024-06-16',4,10000,670),('2024-06-19',5,700,50),('2024-07-01',6,500,45),('2024-07-02',5,740,55),('2024-07-04',7,660,210);
...
INSERT INTO `Insumo` VALUES (0,'',NULL,NULL,NULL),(1,'Ração','500',1,'UN'),(2,'Energia elétrica','3050',1,'kw'),(3,'Cimento','3',2,'sc'),(4,'Àgua','8740',1,'L'),(5,'Medicamentos','675',2,'UN'),(6,'Material de ninho','430',1,'sc'),(7,'Comedouro e Bebedouro','400',1,'UN'),(8,'Caixa\'d água','4000',2,'L'),(9,'Materias de Limpeza','570',1,'UN'),(10,'Mangueira e Vassoura','120',2,'UN');
...
INSERT INTO `UnidadeDeMedida` VALUES ('BN','Bandeja'),('DZ','Dúzia'),('KG','Quilograma'),('kw','Kilowatt/Hora'),('L','Litro'),('sc','Saco com 60 kg'),('UN','Unidade');
...
/*!50001 VIEW `subtotais` AS select 1 AS `idProduto`,1 AS `nomeProduto`,1 AS `SubTotal`,1 AS `data` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-06-11  8:12:11
